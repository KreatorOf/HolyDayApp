  ...
  var body: some View {
    OnboardingScaffold {
      VStack(spacing: 36) {
        ...
        .focused($focused)
        .padding(.vertical, 16)
        .appGlassEffect(in: RoundedRectangle(cornerRadius: 14, style: .continuous))
        .overlay {
...
private struct NotificationsPage: View {
  ...
  private var mockNotificationCard: some View {
    ...
    .padding(12)
    .appGlassEffect(in: RoundedRectangle(cornerRadius: 16, style: .continuous))
    .padding(.horizontal, 24)
  }
}
...
private struct ReassurancePill: View {
  ...
  var body: some View {
    ...
    .padding(.vertical, 12)
    .appGlassEffect(
      tint: AppTheme.supplicationGreen.opacity(0.08),
...
private struct OnboardingPrimaryButton: View {
  ...
  var body: some View {
    Button(action: action) {
      ...
      .appGlassEffect(
        tint: AppTheme.thanksgivingGold.opacity(isEnabled ? 0.75 : 0.2),
