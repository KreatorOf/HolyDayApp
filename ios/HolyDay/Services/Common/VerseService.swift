...
final class VerseService {
  ...
  // suivre les traductions réellement embarquées dans `VerseCorpus` — l'anglais est la Berean
  // Standard Bible, pas la King James : un sigle qui dérive attribue le texte à la mauvaise
  // traduction.
