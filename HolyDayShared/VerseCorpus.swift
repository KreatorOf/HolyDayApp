...
/// Traductions : français = Louis Segond (LSG), anglais = Berean Standard Bible (BSB) —
/// toutes deux dans le domaine public.
...
nonisolated enum VerseCorpus {
  ...
  static let all: [CorpusVerse] = [
    ...
    CorpusVerse(
      ...
      textEN: "Give thanks in every circumstance, for this is God's will for you in Christ Jesus.",
    ...
    CorpusVerse(
      ...
      textEN: "A patient man has great understanding, but a quick-tempered man promotes folly.",
    ...
    CorpusVerse(
      ...
      textEN: "You will keep in perfect peace the steadfast of mind, because he trusts in You.",
