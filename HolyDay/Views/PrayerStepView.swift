...
#Preview {
    ...
    ZStack {
        ...
        VStack(spacing: 16) {
            PrayerStepView(step: PrayerStep.defaultSteps[0], isExpanded: false,
                           isCompleted: false, prayerText: $text0, onTap: {}, onPray: {})
            PrayerStepView(step: PrayerStep.defaultSteps[1], isExpanded: true,
                           ...
                           onTap: {}, onPray: {})
            PrayerStepView(step: PrayerStep.defaultSteps[2], isExpanded: false,
