...
class VerseService {
  ...
  private let frenchVerses: [Verse] = [
    ...
    Verse(
      ...
      reference: "Proverbes 3:5", book: "Proverbes", chapter: 3, verse: 5),
    Verse(
      text:
  ...
  private let englishVerses: [Verse] = [
    ...
    Verse(
      ...
      reference: "Isaiah 55:8", book: "Isaiah", chapter: 55, verse: 8),
    Verse(
      text: "Do not let your hearts be troubled. You believe in God; believe also in me.",
      reference: "John 14:1", book: "John", chapter: 14, verse: 1),
    Verse(
    ...
    Verse(
      ...
      reference: "Matthew 7:7", book: "Matthew", chapter: 7, verse: 7),
    Verse(
